...
import { ResourceDetectionConfigWithLogger } from '@opentelemetry/resources/build/src/config'
...
class AwsEc2Detector implements Detector {
   ...
   */
  readonly AWS_IDMS_ENDPOINT = '0.0.0.0';
  ...
  async detect(_config: ResourceDetectionConfigWithLogger): Promise<Resource> {
    console.log("EndPoint: " + this.AWS_IDMS_ENDPOINT);
